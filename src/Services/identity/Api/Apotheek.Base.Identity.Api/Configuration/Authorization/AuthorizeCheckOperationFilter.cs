...
namespace Apotheek.Base.Identity.Api.Configuration.Authorization
{
    public class AuthorizeCheckOperationFilter : IOperationFilter
    {
        private readonly AdminConfiguration _adminApiConfiguration;

        public AuthorizeCheckOperationFilter(AdminConfiguration adminApiConfiguration)
        {
