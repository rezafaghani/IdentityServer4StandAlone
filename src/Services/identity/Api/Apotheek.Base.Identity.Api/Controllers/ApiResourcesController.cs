...
using Apotheek.Base.Identity.Api.Dtos.ApiResources;
...
namespace Apotheek.Base.Identity.Api.Controllers
{
    ...
    [Authorize(Policy = AuthorizationConsts.AdministrationPolicy, AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
